  ...
  render() {
    ...
    return (
      <InputGroup compact size={size} className={styles.search} style={style}>
        ...
        <Input style={{ width: '50%' }} ref="searchInput" size={size} onChange={this.handleInputChange} onPressEnter={this.handleSearch} defaultValue={keyword} />
